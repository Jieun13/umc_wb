...
import umc.wb.service.RestaurantService.RestaurantQueryService;
...
public class WbApplication {
	...
	public CommandLineRunner run(ApplicationContext context) {
		return args -> {
			...
			System.out.println("Score: " + averageRating);

			storeService.findRestaurantsByNameAndAverageRating(name, averageRating)
